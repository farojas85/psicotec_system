            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Menús/Roles</li>
                    </ol>
                </div>
                <h4 class="page-title">Menús por Roles</h4>
            </div>
        </div>
    </div>
    <div class="row">
                    ...
                    <div class="card-body">
                        <div class="nav flex-column nav-pills nav-pills-tab" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <a class="nav-link mb-2" v-if="roles" v-for="rol in roles" :key="rol.id" 
                                ...
                                href="#" data-toggle="pill" @click="listarMenuRole(rol.id)">
                                @{{rol.name}}
                            </a>
                        </div>
                    </div>
...
@section('scripties')
    <script src="js/sistema/menu_role.js" ></script>
@endsection