...
<div id="ocupacion-create" class="modal fade" tabindex="-1" role="dialog" 
    aria-labelledby="ocupacion-createLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="ocupacion-create-title">Nuevo Ocupaci&oacute;n</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body" id="ocupacion-create-body">
            ...
            <div class="modal-footer" id="ocupacion-create-footer">
